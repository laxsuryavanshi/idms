package com.turtleby.idms.multitenancy.configuration;
...
/** Multitenancy configuration properties (prefix: idms.multitenancy). */
...
public class TenantProperties {
  ...
  public static class Http {
    ...
    public Http(final String headerName) {
      this.headerName = StringUtils.hasText(headerName) ? headerName : DEFAULT_HEADER_NAME;
    }
